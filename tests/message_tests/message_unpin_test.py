...
def test_message_unpin_invalid_token(clear_register_two_createchanneldm_sendmsg):
...
@pytest.mark.usefixtures('clear_register_two_createchanneldm_sendmsg')
def test_message_unpin_invalid_message_id(clear_register_two_createchanneldm_sendmsg):
...
@pytest.mark.usefixtures('clear_register_two_createchanneldm_sendmsg')
def test_successful_message_unpin_owner(clear_register_two_createchanneldm_sendmsg):
...
@pytest.mark.usefixtures('clear_register_two_createchanneldm_sendmsg')
def test_fail_message_unpin_not_owner(clear_register_two_createchanneldm_sendmsg):
